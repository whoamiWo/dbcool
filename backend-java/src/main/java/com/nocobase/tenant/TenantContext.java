...
/**
 * 多租户上下文(Week 41 D6 Step G1 — ADR-007 实现基线).
 *
 * <p>ThreadLocal 持有当前请求的 tenantId,供 service / repository 取用。
 *
 * <p>完整 ADR-007 承诺 Schema 隔离(`SET search_path`),本 Step G1 先实现最小可行版本:
 * <ul>
 ...
 * </ul>
 *
 * <p>Schema 路由(`SET search_path` + Hibernate 集成)推迟到 D6 Step G2。
 *
