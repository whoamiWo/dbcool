...
- **P0 完全 done:25 / 33 = 75.8%**(2026-09-17 更新:US-003、US-102、US-103、US-104、US-106、US-202、US-203 已达 done)
- P0 partial:7(需补齐验收标准)
- P0 not-started:1(US-504 应用切换)
- **结论:若以"done"为 MVP 达标线,MVP 完成率 75.8%,仍需补齐 8 个 P0 方可达标。**

### 7.4 P0 完全 done 清单(25 个)
...
### 7.5 P0 partial 清单(7 个,需补齐)

US-004(关联字段-前端), US-101(拖拽建表单), US-105(预览模式), US-303(字段级权限), US-402(节点拖拽), US-404(邮件通知), US-406(测试工作流)
